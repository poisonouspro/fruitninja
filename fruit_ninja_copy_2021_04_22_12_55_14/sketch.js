...
var knifeImage , fruit1, fruit2 ,fruit3,fruit4, monsterImage, gameOverImage,cutSound,gameOverSound;
...
function draw() {
  ...
  if (score ===  5 || 10 || 15 || 20){
   ...
   if (score === 10 || 20 ||30||40||50){
    monsterGroup.velocityX = monsterGroup.velocityX +5;
  }
